...
export default function InvoiceList() {
  ...
  const dInvoiceNumber = useDebounce(invoiceNumber, 400)
  ...
  const load = useCallback(async () => {
    ...
    try {
      const res = await invoiceAPI.list({
        ...
        invoiceNumber: dInvoiceNumber || undefined,
  ...
  }, [page, dSearch, dInvoiceNumber, status, invoiceType, startDate, endDate])
    ...
    <div className="space-y-4">
      <div className="card">
        ...
        <div className="p-4 border-b border-gray-100 flex flex-wrap gap-2">
          ...
          <SearchBar value={invoiceNumber} onChange={v => { setInvoiceNumber(v); setPage(1) }} placeholder="ស្វែងរកលេខវិក្កយបត្រ..." />
